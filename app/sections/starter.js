...
const Starter = () => {
    return (
        <div className="bg-primary">
            <div className="container pt-20 pb-40 grid lg:grid-cols-2 grid-cols-1">
                <div className="font-normal pr-32">
                    <p className="text-secondary text-sm">Работаем по всей Центральной Азии</p>
                    <p className="text-[56px] leading-[120%] text-white">Маркетинговые исследования услуги под ключ</p>
                    <p className="text-gray-200 text-lg mt-6 mb-11">Мы предоставляем необходимые данные и аналитику для вашего успешного B2B маркетинга</p>
                    <Button>
                ...
                <div className="w-full">
                    <div className="ml-auto w-max relative">
                        ...
                        <Image src={StarterRight} alt={"Right"} className=""/>
